  ...
  return (
    <View style={styles.mainContainerStyle}>
      <View style={styles.subContainerStyle}>
        ...
        <View>
          <Button style={[styles.loginButtonStyle, styles.googleBtn]} iconLeft full rounded>
            <Icon name="logo-googleplus" />
            <Text style={styles.buttonText}>Sign in with Google</Text>
          </Button>
          <Button style={[styles.loginButtonStyle, styles.facebookBtn]} iconLeft full rounded>
            <Icon name="logo-facebook" />
            <Text style={styles.buttonText}>Sign in with Facebook</Text>
          </Button>
          <Button style={[styles.loginButtonStyle, styles.createAccBtn]} iconLeft full rounded>
